                 ...
                 <NB.Header  transparent style={{paddingLeft:0,paddingRight:0, }}>
                  ...
                  <NB.Header  transparent>
                      ...
                      {/* <NB.Segment style={{backgroundColor:'transparent',width:"100%",alignItems:"center",justifyContent:"center"}}> */}
                          <NB.Text style={{color:'#fff',fontSize:23,fontSize: width * 0.05,fontFamily:'OpenSans-Bold'}}>Messages</NB.Text>
                          {/* </NB.Segment> */}
                      </NB.Body>
                    ...
                    <SwipeListView
                              ...
                              <View style={{flex:1,flexDirection: 'row',paddingLeft:70,paddingRight:70,height:90,}}>
                                 <View style={{justifyContent:"flex-start",alignItems:'center',paddingRight:20,paddingTop:10,marginLeft:-10}}>
                                  ...
                                  <View style={{width:"100%"}}>
                                      ...
                                      {id: data.item.id, name: data.item.name, user_id: data.item.user_id})}  style={{color:'#1c1721',textAlign:'left',fontSize: width * 0.033,paddingBottom:10,height:57,fontFamily:'OpenSans-Bold' }}>{data.item.message} </Text>  
                        ...
                        <TouchableOpacity
                               ...
                               <Animated.View
                                    ...
                                    >
                                {/* <Image source={require('../Image/delete.png')} style={{width:28 , zIndex: 999, position:'absolute'}} />   */}
                                </Animated.View>
                                <Image source={require('../Image/delete.png')} style={styles.backLeftBtnRight} />  
                                </TouchableOpacity>   
                                ...
                                >
                                    ...
                                    >
                                    {/* <Image source={require('../Image/delete.png')} style={{width:50 }} />   */}
                                    </Animated.View>
                                    <Image source={require('../Image/delete.png')} style={styles.backRightBtnLeft} />
                                </TouchableOpacity>
                            </View>
                        )}
                        leftOpenValue={98}
