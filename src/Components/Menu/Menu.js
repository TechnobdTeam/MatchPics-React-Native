...
import {Dimensions, View, Image, ImageBackground,NativeModules, 
  processColor,TouchableOpacity, Platform, Linking} from 'react-native';
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem(ConstValues.user_logged_in , (error, result) => {
        ...
        //   this.timeoutHandle = setTimeout(()=>{
          ...
          AsyncStorage.getItem(ConstValues.subscription_url, (error, result) =>{

            if(result != null){
              console.log("subscription_url>>> " + JSON.parse(result));
              this.setState({subscription_url: JSON.parse(result)})
            }
          })
        // }, 1500);
        }
...
openSubscriptionUrl(){
  ...
  Linking.canOpenURL(this.state.subscription_url).then(supported => {
    if (supported) {
      Linking.openURL(this.state.subscription_url);
    } else {
      NB.Toast.show({
                    ...
                    <NB.Content style={{backgroundColor:'#fff', borderBottomLeftRadius:10,borderBottomRightRadius:10,}}>
                          ...
                          <NB.View style={{
                            ...
                            <NB.Content >
                                    ...
                                    <TouchableOpacity  onPress={() => {this.popScreen(),this.props.navigation.navigate('MyProfile')}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                       ...
                                       <Icon name="user-circle"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                        ...
                                        <NB.Body>
                                        {/* <NB.Text   style={{textTransform:'uppercase',color:"#464646",fontFamily:'OpenSans-Bold',fontSize: width * 12.88 }}>my profile</NB.Text> */}
                                        <NB.Text style={{fontSize: width * 0.04,textTransform:'uppercase',color:"#464646",fontFamily:'OpenSans-Bold', }}>my profile</NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            ...
                            <NB.Content>
                                    <NB.ListItem style={{marginLeft:0,paddingLeft:25,height:65}} >
                                    <TouchableOpacity  onPress={() => {this.popScreen(), this.props.navigation.navigate('UploadImage')}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                    <NB.View style={{width:50,justifyContent:"center",alignItems:"center"}}>
                                    <Icon name="cloud-upload-alt"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                    </NB.View>
                                        <NB.Body>
                                        <NB.Text  style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}}>upload photo </NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    ...
                                    <TouchableOpacity  onPress={() => {this.popScreen(), this.props.navigation.navigate('MyMatchesFavorite')}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                    <NB.View style={{width:50,justifyContent:"center",alignItems:"center"}}>
                                    <Icon name="user-friends"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                    </NB.View>
                                        <NB.Body>
                                        <NB.Text   style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >my matches</NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    <NB.ListItem style={{marginLeft:0,paddingLeft:25,height:65}} >
                                    <TouchableOpacity  onPress={() => {this.popScreen(),this.props.navigation.navigate('MyFavorite')}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                    <NB.View style={{width:50,justifyContent:"center",alignItems:"center"}}>
                                    <Icon name="heart"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                    </NB.View>
                                        <NB.Body>
                                          <NB.Text  style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >my favorite</NB.Text>
                                        </NB.Body>
                                       </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    ...
                                    <Icon name="comments"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                        ...
                                        <NB.Body>
                                             <NB.Text style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >messages</NB.Text> 
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    <NB.ListItem style={{marginLeft:0,paddingLeft:25,height:65}}>
                                    <TouchableOpacity  onPress={() => {this.popScreen(), this.props.navigation.navigate('AppSearch')}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                    <NB.View style={{width:50,justifyContent:"center",alignItems:"center"}}>
                                    <Icon name="search"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                    </NB.View>
                                        <NB.Body>
                                        <NB.Text   style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >search</NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    <NB.ListItem style={{marginLeft:0,paddingLeft:25,height:65}}>
                                    <TouchableOpacity  onPress={() => {this.popScreen(), this.openSubscriptionUrl()}} style={{width:"100%",flex:1,flexDirection:"row"}}>
                                    <NB.View style={{width:50,justifyContent:"center",alignItems:"center"}}>
                                    <Icon name="shopping-cart"  style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                    </NB.View>
                                        <NB.Body>
                                        <NB.Text style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >buy subscription</NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content>
                            ...
                            <NB.Content>
                                    ...
                                    <Icon name="balance-scale" style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                        ...
                                        <NB.Body>
                                        <NB.Text   style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >terms & conditions</NB.Text>
                                        </NB.Body>
                            ...
                            <NB.Content>
                                    ...
                                    <Icon name="door-open" style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                        ...
                                        <NB.Body>
                                          <NB.Text style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >Sign in </NB.Text>
                                        </NB.Body>
                                        </TouchableOpacity>
                                    </NB.ListItem>
                            </NB.Content> 
                            ...
                            <NB.Content style={{}}>
                                    ...
                                    <Icon name="door-open" style={{fontSize: width * 0.05,color:'#e41b5b', }}  /> 
                                        ...
                                        <NB.Body>
                                        <NB.Text   style={{textTransform:'uppercase',fontSize: width * 0.04,color:"#464646",fontFamily:'OpenSans-Bold'}} >Sign Out</NB.Text>
                                        </NB.Body>
                                      </TouchableOpacity>
