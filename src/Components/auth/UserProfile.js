...
import {Animated, Button,View, StyleSheet, ImageBackground,ScrollView,
    SafeAreaView ,TouchableOpacity, Dimensions, KeyboardAvoidingView, Platform} from 'react-native';
...
export class UserProfile extends React.Component {
   ...
   renderInner = () => (
    ...
    <NB.View style={{paddingLeft:23,}} >
                ...
                <ScrollView style={{paddingRight:20, height: 430}} > 
                    <NB.Text style={{marginBottom:10,color:'#fff',lineHeight:22,fontSize: width * 0.039,textAlign: 'justify',fontFamily:'OpenSans-Bold'}} >
                    ...
                    <NB.Footer style={{height:72}} >
                        <NB.FooterTab style={{backgroundColor:'#fff',}}>
                         ...
                         <TouchableOpacity onPress={() => this.props.navigation.navigate('Chatwindow',
                            ...
                            <NB.Text style={{textAlign:"center",color:'#333333',fontSize: width * 0.033,fontFamily:'OpenSans-Bold'}}>Message</NB.Text>
                            </TouchableOpacity>
                            </NB.Button>
                            ...
                            <NB.Text style={{textAlign:"center",color:'#333333',fontSize: width * 0.033,fontFamily:'OpenSans-Bold'}} >Favorite</NB.Text>
                          </TouchableOpacity>
                            </NB.Button>
                            <NB.Button   vertical > 
                           <TouchableOpacity onPress={() => this.setState({confirmVisible: true})}
                           ...
                           > 
                            ...
                            <NB.Text   style={{textAlign:"center",color:'#333333',fontSize: width * 0.033,fontFamily:'OpenSans-Bold'}}>Block</NB.Text>
                            </TouchableOpacity>
                            </NB.Button>
                            ...
                            <NB.Text style={{color:'#333333',textAlign:"center",fontSize: width * 0.033,fontFamily:'OpenSans-Bold'}}>Report</NB.Text>
                            </TouchableOpacity> 
                            </NB.Button>
 ...
 <NB.Spinner color='#fff' />
    ...
    <ConfirmDialog
        ...
        <View style={{marginLeft:-24,marginRight:-24,marginTop:-24,marginBottom:-30,padding:24, backgroundColor: 'white'}}>
            ...
            <View style={{ borderBottomWidth:1,borderBottomColor:"#ededed",marginBottom:20,alignItems:"flex-end",paddingBottom:7}}>
                ...
                <ScrollView >
                <View  style={{backgroundColor: 'white', flexWrap:"wrap", display:'flex',alignContent:"space-around",flexDirection: 'row',}} > 
                ...
                <View style={{marginTop:10,}}> 
                    ...
                    <NB.Text style={{backgroundColor:"#e5e6eb",textAlign:"center",padding:7,borderRadius:7,fontSize:17,color:"#979797"}}> SUBMIT </NB.Text>  
                    :
                    // <NB.Text style={{backgroundColor: 'red', width: 100, height: 100}} onPress={()=>console.log("hello clicked")}>Hello</NB.Text>
                    <NB.Text onPress={() => {
                        this.setState({Report: false}),
                        this.reportAgainstUser()
                    }} style={{backgroundColor:"#e41b5b",textAlign:"center",padding:7,borderRadius:7,fontSize:17,color:"#ffffff"}}> SUBMIT </NB.Text>
                    }
                    </TouchableOpacity> 
                </View>
