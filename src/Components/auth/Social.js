                  ...
                  <NB.CardItem style={{backgroundColor:'transparent'}} > 
                     ...
                     <NB.Button  iconRight transparent style={{ }}>
                      ...
                      <NB.Left style={{width:'100%',justifyContent: 'center', alignItems:'center'}}>
                          <NB.Text style={{fontSize: width * 0.08,color:'#333333',alignItems:'center',justifyContent:'center',fontFamily:'OpenSans-Bold',}} > Edit Profile  </NB.Text> 
                           ...
                           <NB.Item style={{borderBottomWidth:0,}}>
                              ...
                              <NB.View style={{backgroundColor:'#fff',paddingLeft:0,marginLeft:-17,}} >
                                ...
                                <NB.List  >
                                    ...
                                    <NB.Left>
                                        <NB.Text style={{color:'#696969',textTransform:"uppercase",paddingLeft:30,fontFamily:'OpenSans-Bold',fontSize: width * 0.039}}>looking for</NB.Text>
                                    </NB.Left>
                                    <NB.Right style={{flex:1}} >
                                       <NB.Text style={{color:'#696969',alignItems:"center",justifyContent:"center", fontFamily:'OpenSans-Bold',fontSize: width * 0.039,paddingRight:15,}}>{this.state.looking_for} <Icon name="chevron-right"  style={{color:'#c6c6c6', fontSize: width * 0.039}}  /></NB.Text> 
                                    </NB.Right>
                                    </NB.ListItem>
                                 </NB.List> 
                                 <NB.List  >
                                    ...
                                    <NB.Left>
                                        <NB.Text style={{color:'#696969',textTransform:"uppercase",paddingLeft:30,fontFamily:'OpenSans-Bold',fontSize: width * 0.039}}>Age range</NB.Text>
                                    </NB.Left>
                                    <NB.Right>
                                  <NB.Text style={{color:'#696969',fontSize: width * 0.039,alignItems:"center",justifyContent:"center",fontFamily:'OpenSans-Bold',paddingRight:15,}}>{this.state.user_min_age} - {this.state.user_max_age}</NB.Text> 
                                    </NB.Right> 
                                    </NB.ListItem>
