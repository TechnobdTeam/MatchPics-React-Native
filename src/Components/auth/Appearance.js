                     ...
                     <NB.View style={HomeStyle.EditprofilePageView} >
                          ...
                          <NB.CardItem style={{backgroundColor:'transparent'}} >  
                              ...
                              <NB.Left style={{width:'100%',justifyContent: 'center', alignItems:'center'}}>
                                 <NB.Text style={{fontSize: width * 0.08,fontFamily:'OpenSans-Bold',color:'#333333',alignItems:'center',justifyContent:'center'}} > Edit Profile  </NB.Text> 
                                 ...
                                 <NB.Form>
                                    ...
                                    <NB.Item style={{borderBottomWidth:0,}}>
                                       ...
                                       <NB.List  >
                                             ...
                                             <NB.Left   >
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>Ethnicity</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:2}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',fontSize: width * 0.039,fontFamily:'OpenSans-Bold',alignItems:"center",justifyContent:"center", }}>{this.state.user_ethnicity}  <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,ffontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>body type</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_body_type}  <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>Hair color</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_hair_color}  <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>eye color</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_eye_color} <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                    ...
                                    <NB.View style={{backgroundColor:'#fff',paddingLeft:0,marginLeft:-17,}} >
                                          ...
                                          <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,width:"60%",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>favorite way to spend time</NB.Text>
                                          
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_spend_time} <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>Smoking</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_smoking} <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>drinking</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>{this.state.user_drinking} <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List>
                                          ...
                                          {/* <NB.List  >
                                             ...
                                             <NB.Left>
                                                <NB.Text style={{color:'#333333',textTransform:"uppercase",paddingLeft:30,fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>asdfas dfasdf</NB.Text>
                                             </NB.Left>
                                             <NB.Right style={{flex:1,}}>
                                                <NB.Text style={{paddingRight:15,color:'#696969',alignItems:"center",justifyContent:"center",fontSize: width * 0.039,fontFamily:'OpenSans-Bold',}}>asdfasdfasdf  <Icon name="chevron-right"  style={{color:'#c6c6c6',paddingRight:25,fontSize: width * 0.039,}}  /></NB.Text> 
                                             </NB.Right>
                                             </NB.ListItem>
                                          </NB.List> */}
