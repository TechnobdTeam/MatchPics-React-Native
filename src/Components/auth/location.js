...
export class location  extends React.Component {
    ...
    watchLocation() {
      ...
      Geolocation.getCurrentPosition(info =>{
        ...
        this.setState({
         ...
         console.log("location_data3: " + CHANGED_LATITUDE)
        console.log("location_data4: " + CHANGED_LONGITUDE)
  ...
  moveLocation() {
    ...
    this.setState({
     ...
     console.log("location_data1: " + CHANGED_LATITUDE)
     console.log("location_data2: " + CHANGED_LONGITUDE)
        ...
        <ImageBackground source={require('../Image/background_images.jpg') } style={{width: '100%', height: '100%', }}   > 
          <NB.Container   style={HomeStyle.EditprofileContainer}  >
            <NB.View style={HomeStyle.EditprofilePageView} >
                        ...
                        <View style={{flex: 3,}} > 
                          <NB.Item style={{borderBottomWidth:0,}}>
                                ...
                                <TouchableOpacity onPress={() => {this.setState({showSearch: true})}} >
                                    <NB.CardItem   > 
                                        <NB.Body>
                                            <NB.Text  style={{color:'#333333',textTransform:"uppercase",paddingLeft:3,fontFamily:'OpenSans-Bold',fontSize: width * 0.032,}}>My current location</NB.Text>
                                                {(this.state.user_location == undefined || this.state.user_location == '') ? 
                                                  <NB.Text  style={{color:'#696969',textTransform:"uppercase",paddingLeft:3,fontFamily:'OpenSans-Bold',fontSize: width * 0.032,}}>Set Location</NB.Text>
                                                  :
                                                  <NB.Text  style={{color:'#696969',textTransform:"uppercase",paddingLeft:3,fontFamily:'OpenSans-Bold',fontSize: width * 0.032,}}>{this.state.user_location}</NB.Text>
                                                }
                                            </NB.Body>  
                                        <View >
                ...
                {CHANGED_LATITUDE != '' && CHANGED_LONGITUDE != '' ? 
                      ...
                      >
                       { this.state.location_loaded ? 
                              <MapView.Marker
                                  ...
                                  description={this.state.location_address}
                              /> :
