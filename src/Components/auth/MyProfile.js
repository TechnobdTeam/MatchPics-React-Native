            ...
            <ImageBackground source={require('../Image/profile_bg.png') } style={{width: '100%', height: '100%', paddingRight:0,marginRight:0,backgroundColor:'#f4f4f4'}}   > 
                    ...
                    <NB.Container   style={HomeStyle.MyprofileContainer}  >
                        <NB.Header  transparent >
                            ...
                            <NB.Body >
                            {/* <NB.Segment style={{backgroundColor:'red', borderWidth: 1,width: '100%' ,borderColor: 'yellow' ,alignItems:"center",justifyContent:"center"}}> */}
                                <NB.Text style={{color:'#fff',fontSize: width * 0.05, fontFamily:'OpenSans-Bold'}} >My Profile</NB.Text>
                                {/* </NB.Segment> */}
                            </NB.Body>
                            <NB.Right>
                                <NB.Button transparent>
                                            ...
                                            <NB.CardItem style={HomeStyle.UserProfileImages}  >
                                                ...
                                                <NB.Right>
                                                    <NB.Button onPress={() => this.props.navigation.navigate('ProfileEdit')}   light style={{backgroundColor:'#e32a89',borderRadius:7,height:35,marginTop:5,}}> 
                                                        <NB.Text style={{color:'#fff',textTransform:'capitalize',fontFamily:'OpenSans-Bold',fontSize: width * 0.032,}}>Change</NB.Text>
                                                    </NB.Button>
                                            ...
                                            <NB.CardItem style={HomeStyle.UserProfileImages}  >
                                                ...
                                                <NB.Right>
                                                    <NB.Button onPress={() => this.props.navigation.navigate('location')}  light style={{backgroundColor:'#f68e1e',borderRadius:7,height:35,marginTop:5,}}> 
                                                        <NB.Text style={{color:'#fff',textTransform:'capitalize',fontSize: width * 0.032,fontFamily:'OpenSans-Bold',}}>Change</NB.Text>
                                                    </NB.Button>
