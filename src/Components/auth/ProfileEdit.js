...
import { Image, ImageBackground,TouchableOpacity, Platform,  Radio,View, Button,Dimensions} from 'react-native';
          ...
          <Fragment>    
            <ImageBackground source={require('../Image/background_images.jpg') } style={{width: '100%', height: '100%', }}   > 
                              ...
                              <NB.Item style={{borderBottomWidth:0,}}>
                                  ...
                                  <NB.View style={{backgroundColor:'#fff',paddingLeft:0,marginLeft:-17,}} >
                                    ...
                                    {this.state.name_visible == false ?
                                        ...
                                        <NB.Input style={{fontFamily:'OpenSans-Bold',fontSize: width * 0.039,paddingLeft:30,}} 
                                        ...
                                        <NB.Left>
                                            <NB.Text style={{color:'#696969',textTransform:"uppercase",paddingLeft:30,fontFamily:'OpenSans-Bold',fontSize: width * 0.039}}>{this.state.user_name}</NB.Text>
                                        </NB.Left>
                                        <NB.Right>
              ...
              {ConstValues.profile_all_details.basic.here_for.map((item,i) => {
                ...
                <NB.Body>
                  <NB.Text style={{color:"#696969",fontFamily:'OpenSans-Bold',fontSize: width * 0.039}}>{item.name}</NB.Text>
                </NB.Body>
                <NB.CheckBox
              ...
              <NB.Body>
                ...
                />
                              ...
                              <NB.View style={{backgroundColor:'#fff',marginLeft:-17,}} >
                                    ...
                                    <NB.List  >
                                        ...
                                        <NB.Left>
                                            <NB.Text onPress={() => this.datepicker()}   style={{color:'#696969',paddingLeft:30,textTransform:"uppercase",fontFamily:'OpenSans-Bold',fontSize: width * 0.039}}>{this.state.user_dob != '' ? this.state.user_dob : "Select Birthday"}</NB.Text>
                ...
                {/* ios date picker design */}

                {(Platform.OS == 'ios' && this.state.show) && (

              <View style={{backgroundColor:"white", position: 'absolute', height: '100%', width: '100%'}}>
                  <NB.Content style={{width: '100%',}}>
                  <NB.Text onPress={() => {this.setDate(), this.setState({show: false})}} style={{position: 'absolute', fontSize: 20,fontFamily: 'OpenSans-Bold', marginTop: 20, marginRight: 20, right: 0}} >Select</NB.Text>
                  <NB.Text onPress={() => {this.setState({show: false})}} style={{position: 'absolute', color: 'gray', fontFamily: 'OpenSans-Semibold', fontSize: 20, marginTop: 20, marginLeft: 20, textAlign:'left'}} >Cancel</NB.Text>
                  </NB.Content>
                  <View style={{marginTop: 150, backgroundColor:"white", position: 'absolute', height: '100%', width: '100%', justifyContent: 'center'}}>
