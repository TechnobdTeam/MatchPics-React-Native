    ...
    renderItem =({ item, index }) => {
      ...
      return (
        ...
        <View style={{flex:1,flexDirection: 'row',paddingLeft:70,paddingRight:70,height:84,}}>
            ...
            <Text  numberOfLines={2}  style={{color:'#1c1721',textAlign:'left',fontSize:14,marginBottom:4,paddingBottom:10,fontFamily:'OpenSans-Bold',}}>{item.notification}  </Text> 
    ...
    render() {
      ...
      <NB.Header  transparent>
        ...
        {/* <NB.Segment style={{backgroundColor:'transparent',width:"100%",alignContent:"center",justifyContent:"center"}}> */}
            <NB.Text style={{color:'#fff',fontSize: width * 0.05,fontFamily:'OpenSans-Bold'}}>Notifications </NB.Text>
            {/* </NB.Segment> */}
        </NB.Body>
