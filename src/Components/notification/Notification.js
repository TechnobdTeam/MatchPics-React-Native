                              ...
                              <View    style={styles.rowFront}>
                                  <View style={{flex:1,flexDirection: 'row',paddingLeft:70,paddingRight:70,height:84,}}>
                                      <View style={{justifyContent:'center',alignItems:'center',paddingRight:20,}}>
                                          <Image source={{uri: item.url}} style={{ width: 75, height: 75, borderRadius: 37.5 }} />
                                      </View>
                                      ...
                                      <Text numberOfLines={3}  style={{color:'#1c1721',textAlign:'left',fontSize:14,marginBottom:4}}>{item.notification}  </Text> 
